...
class EventHandler:
    ...
    def run_selection(self, events):
        ...
        for cut in self.cut_map:
            ...
            # Apply the mask to each branch at the event level
            # events = {key: array[event_mask] for key, array in events.items()}
            #print("EMASK", event_mask.type)
            #events = events[event_mask]
            #print("POSTMASK", events.type)
