    ...
    def run_selection(self, events):
        ...
        for i, cut in enumerate(self.cut_map):
            ...
            if i == 0:
                ...
                event_mask = self.cut_map[cut].selection(events[event_mask], self.Hist_object)

            print("Cut", cut, " selected", ak.sum(event_mask, axis=0), "events")

        # Return all the histograms generated by the selection and the mask
        return self.Hist_object.get_hist_map(), event_mask
